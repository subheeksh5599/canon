...
| The agent's deliverable came from its own Virtuals compute | generation `gen-1789021529-lQTOAU4WPbwdOTiaF2KV` via `POST /api/virtuals/deliver/{tx_id}`; inference cost $0.000114 billed to Spark-Tier credits | `canon/virtuals.py`; the console tx record |
